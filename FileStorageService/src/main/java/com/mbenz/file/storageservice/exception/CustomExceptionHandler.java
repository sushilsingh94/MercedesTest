...
import com.mbenz.file.storageservice.dto.ErrorResponse;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    public final ResponseEntity<ErrorResponse> handleFileWriteException(FileWriteException ex, WebRequest request) {
        ErrorResponse errorDetails = new ErrorResponse("Error occurred while writing data to file ", Arrays.asList(ex.getMessage()));
